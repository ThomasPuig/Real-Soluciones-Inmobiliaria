let inmueblesDisponibles = [
    ...
    inmueblesDisponibles.forEach((inmueble) => {
        ...
        <div class="contenido">
            ...
            <button id="btn1">Agendar Visita</button>
        </div>
    </div>`
    ...
    document.getElementById(`${inmueble.id}`).addEventListener("click",  () => funcionDescripcion(inmueble))
    }
...
// !ESTA ES EL METODO QUE UTILICE EN LAS ENTREGAS INICIALES PARA MOSTRAR!//
//programarBotones()
//function programarBotones() {
    //const boton = document.getElementById("btn1");
